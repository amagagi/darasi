...
class AdminPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->favicon(asset('images/favicon.ico'))  // ← Ajoute cette ligne
                ...
                ->groups([
                    ...
                    NavigationGroup::make('Tests & Évaluations')
                        ...
                        ->items([
                            ...
                            NavigationItem::make('Tests finaux')->url('/admin/test-finaux'),
                    ...
                    NavigationGroup::make('Demandes & Certificats')
                        ...
                        ->items([
                            ...
                            NavigationItem::make('Demandes formation')->url('/admin/demandes-formation'),
                        ]),
                ]);
            })
